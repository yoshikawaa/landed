...
![Landed Screenshot](/images/screenshot.png?raw=true)
...
If you are using Netlify to host your hugo site, you will want to add it as a submodule instead of cloning:
    ...
    $ git submodule add https://github.com/yoshikawaa/landed themes/landed
...
There is an [`exampleSite`](/exampleSite) folder for this theme. Copy the file called [`config.toml`](/exampleSite/config.toml) to your websites root directory.
